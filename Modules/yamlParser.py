...
class EmptySupplyData(Exception):
    ...
    def __init__(self):
        self.message = (
            "No se encuentran datos de la oferta, asegúrese de que el archivo se encuentra en el directorio "
...
class EmptyDemandData(Exception):
    ...
    def __init__(self):
        self.message = (
            "No se encuentran datos de la demanda, asegúrese de que el archivo se encuentra en el directorio "
            "correcto y se ha cargado correctamente")
        super().__init__(self.message)
...
class Parser:
    ...
    def getRawDataFromFile(self, path):
        """
        Esta funcion lee el contenido del archivo en la direccion introducida a la funcion como parametro
        :param path: Direccion del archivo .yml del que se van a extraer los datos.
    ...
    def getRawDataFromSupply(self):
        """
        Esta funcion lee el contenido del archivo de oferta y lo almacena en self.supplyData.
        :return: None
        """
        try:
    ...
    def getRawDataFromDemand(self):
        """
        Esta funcion lee el contenido del archivo de demanda y lo almacena en self.demandData
        :return: Devuelve los datos almacenados en el archivo indicado en path.
        """
        try:
    ...
    def getStations(self):
        """
        Funcion que obtiene los datos dentro de stations en el archivo Yaml de la oferta.
    ...
    def getSeat(self):
        """
        Funcion que obtiene los datos dentro de seat en el archivo Yaml de la oferta.
    ...
    def getCorridor(self):
        """
        Funcion que obtiene los datos dentro de corridor en el archivo Yaml de la oferta.
    ...
    def getLine(self):
        """
        Funcion que obtiene los datos dentro de line en el archivo Yaml de la oferta.
    ...
    def getRollingStock(self):
        """
        Funcion que obtiene los datos dentro de rollingStock en el archivo Yaml de la oferta.
    ...
    def getTrainServiceProvider(self):
        """
        Funcion que obtiene los datos dentro de trainServiceProvider en el archivo Yaml de la oferta.
    ...
    def getTimeSlot(self):
        """
        Funcion que obtiene los datos dentro de timeSlot en el archivo Yaml de la oferta.
    ...
    def getService(self):
        """
        Funcion que obtiene los datos dentro de service en el archivo Yaml de la oferta.
    ...
    def getMarket(self):
        """
        Funcion que obtiene los datos dentro de market en el archivo Yaml de la demanda.
    ...
    def getUserPattern(self):
        """
        Funcion que obtiene los datos dentro de userPattern en el archivo Yaml de la demanda.
    ...
    def getDemandPattern(self):
        """
        Funcion que obtiene los datos dentro de demandPattern en el archivo Yaml de la demanda.
    ...
    def getDay(self):
        """
        Funcion que obtiene los datos dentro de day en el archivo Yaml de la demanda.
    ...
    def getTrainServiceProviderByIndex(self, index):
        ...
        try:
            if self.supplyData is None: raise EmptySupplyData
            TrainServiceProvider.append(self.getTrainServiceProvider()[index].get("id"))
            TrainServiceProvider.append(self.getTrainServiceProvider()[index].get("name"))
            TrainServiceProvider.append(json.dumps(self.getTrainServiceProvider()[index].get("rolling_stock")))
            return TrainServiceProvider
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
    ...
    def getStationsByIndex(self, index):
        ...
        try:
            ...
            Stations.append(json.dumps(self.getStations()[index].get("coordinates")))
            return Stations
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
    ...
    def getCorridorByIndex(self, index):
        ...
        try:
            ...
            Corridor.append(self.extractStationsFromCorridor(self.getCorridor()[index].get("stations")))
            return Corridor
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
    ...
    def getLineByIndex(self, index):
        ...
        try:
            ...
            Line.append(self.extractStopsFromLine(self.getLine()[index].get("stops")))
            return Line
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
    ...
    def extractStopsFromLine(stopsData: list):
        """
        Esta función extrae todas las paradas con sus tiempos de llegada y salida de una linea.
    ...
    def getMarketByIndex(self, index):
        ...
        try:
            ...
            Market.append(json.dumps(self.getMarket()[index].get("departure_station_coords")))
            Market.append(self.getMarket()[index].get("arrival_station"))
            Market.append(json.dumps(self.getMarket()[index].get("arrival_station_coords")))
            return Market
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
    ...
    def getDemandPatternByIndex(self, index):
        ...
        try:
            ...
            DemmandPattern.append(self.extractMarketsFromDemmandPattern(self.getDemandPattern()[index].get("markets")))
    ...
    def getUserPatternByIndex(self, index):
        ...
        {"start":<FdhStart>,"end":<FdhEnd>},{<seatID_0>:<utility_0>,...,<seatID_n>:<utility_n>},
        {"<TspID_0>":<utility_0>,...,"<TspID_n>":<utility_n>},<early_stop>,<utility_threshold>,<error>,
        ...
        try:
            ...
            UserPattern.append(json.dumps(self.getUserPattern()[index].get("rules")))
            UserPattern.append(self.reformatVariableSets(self.getUserPattern()[index].get("variables")))
            UserPattern.append(self.getUserPattern()[index].get("arrival_time"))
            UserPattern.append(json.dumps(self.getUserPattern()[index].get("arrival_time_kwargs")))
            ...
            UserPattern.append(json.dumps(self.getUserPattern()[index].get("error_kwargs")))
            return UserPattern
        except IndexError:
            print("Se ha sobrepasado el índice máximo")
            return "indexError"
